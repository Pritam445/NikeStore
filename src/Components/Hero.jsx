...
const Hero = ({heroapi:{title, subtitle, img, btntext, videos, sociallinks}}) => {
  ...
  return (
    <div className=' relative flex flex-col h-auto w-auto'>
        <div className='bg-theme clip-path h-[85vh] lg:h-[75vh] mb:h-[65vh] sm:h-[55vh] 
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
            <div className='grid items-center justify-items-center mt-28 md:mt-24'>
                ...
                <button type='submit' className='button-theme bg-slate-200 shadow-slate-200 rounded-xl my-5'>{btntext}</button>
                ...
                <div className='grid items-center gap-3 absolute top-[30vh] md:top-[20vh] lg:top-[35vh] sm:top-[27vh] right-0 '>

                    {sociallinks?.map((link,i) => (
                        <SocialLinks key={i} icons={link.icon} />
                    ))}
