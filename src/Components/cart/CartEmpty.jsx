  ...
  return (
    <>
        ...
        <div className='flex flex-col items-center justify-center h-screen px-11 text-center gap-7'>
            ...
            <button type='button' onClick={onCartToggle} className='button-theme bg-gradient-to-b from-amber-500 to-orange-500 shadow-lg shadow-orange-500 flex items-center justify-center text-slte-900 py-2 gap-3 text-sm px-5 font-semibold active:scale-110'>
